[![npm version](https://img.shields.io/npm/v/@wemnyelezxnpm/quod-porro-aut.svg)](https://www.npmjs.com/package/@wemnyelezxnpm/quod-porro-aut)
[![npm downloads](https://img.shields.io/npm/dm/@wemnyelezxnpm/quod-porro-aut.svg)](https://www.npmjs.com/package/@wemnyelezxnpm/quod-porro-aut)
[![Build Status](https://github.com/wemnyelezxnpm/quod-porro-aut/workflows/CI/badge.svg)](https://github.com/wemnyelezxnpm/quod-porro-aut/actions)
...
```
npm i @wemnyelezxnpm/quod-porro-aut
```

To use in an ESM file:

```js
import * as @wemnyelezxnpm/quod-porro-aut from "@wemnyelezxnpm/quod-porro-aut";

const ast = @wemnyelezxnpm/quod-porro-aut.parse(code);
```

To use in a Common JS file:

```js
const @wemnyelezxnpm/quod-porro-aut = require("@wemnyelezxnpm/quod-porro-aut");
...
```js
const ast = @wemnyelezxnpm/quod-porro-aut.parse('let foo = "bar"', { ecmaVersion: 6 });
console.log(ast);
```
...
const tokens = @wemnyelezxnpm/quod-porro-aut.tokenize('let foo = "bar"', { ecmaVersion: 6 });
console.log(tokens);
```
...
Returns the current `@wemnyelezxnpm/quod-porro-aut` version
...
Returns the latest ECMAScript supported by `@wemnyelezxnpm/quod-porro-aut`
...
Issues and pull requests will be triaged and responded to as quickly as possible. We operate under the [ESLint Contributor Guidelines](http://eslint.org/docs/developer-guide/contributing), so please be sure to read them before contributing. If you're not sure where to dig in, check out the [issues](https://github.com/wemnyelezxnpm/quod-porro-aut/issues).
